...
function help() {
  printf "\033[33m# HELP: api_messages_listing\n\033[0m"
  printf "\033[33m# Expected parameters:\t-\n\033[0m"
  printf "\033[33m# Optional parameters:\tpage <integer>\n\033[0m"
  printf "\033[33m# \t\t\tper_page <integer>\n\033[0m"
  printf "\033[33m# Usage:\t\t./api_messages_listing.sh\n\033[0m"
  printf "\033[33m# \t\t\t./api_messages_listing.sh '{\"page\":1}' #where 1 is a page number\n\033[0m"
  printf "\033[33m# \t\t\t./api_messages_listing.sh '{\"per_page\":50}' #where 50 is a number of messages to display per page\n\033[0m"
  printf "\033[33m# \t\t\t./api_messages_listing.sh '{\"page\":1,\"per_page\":50}'\n\033[0m"
}
